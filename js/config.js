...
var CONFIG = {
    ...
    itemPool: [
        ...
        { name: "初始盾牌", type: "shield", def: 3, rarity: "common", price: 15, icon: "🛡️" },
    ...
    achievements: [
        ...
        // 賭場成就
        { id: "gambler", name: "🎲 賭徒", cond: "進行賭博 100 次", rarity: "legendary", check: (p) => p.casinoStats && p.casinoStats.gamesPlayed >= 100 },
        ...
        { id: "unlucky_draw", name: "😭 非酋", cond: "裝備抽獎連續 5 次未出稀有", rarity: "epic", check: (p) => p.casinoStats && p.casinoStats.gachaStreak >= 5 },
        // Hidden Achievements
    ...
    hub: {
        ...
        unlockDepthCost: 500, // 每 100 層解鎖消耗 EP
        challengeMultiplier: {
            difficulty: 2.0, // 怪物強度倍率
            reward: 2.0      // EP 獎勵倍率
        }
    },
    // --- [新增: 符文系統配置] ---
    runes: {
        starting_potion: { id: 'starting_potion', name: '⚗️ 初始藥水', desc: '新冒險開始時額外獲得 2 瓶治療藥水', cost: 300, effect: { type: 'initial_item', item: '治療藥水', count: 2 } },
        passive_gold: { id: 'passive_gold', name: '💰 貪婪之手', desc: '永久提升金幣獲取量 15%', cost: 1000, effect: { type: 'gold_mult', val: 0.15 } },
        crit_boost: { id: 'crit_boost', name: '⚡ 致命專注', desc: '永久提升基礎暴擊率 3%', cost: 800, effect: { type: 'crit_base', val: 3 } },
        strong_heal: { id: 'strong_heal', name: '🌿 治癒之風', desc: '休息事件恢復量額外提升 50%', cost: 500, effect: { type: 'heal_boost', val: 0.5 } }
    },
    ...
    recipes: {
        ...
        potion_atk: {
            id: 'potion_atk',
            name: '💥 攻擊強化藥劑',
            desc: '在下次事件開始時，獲得【惡魔的狂怒】Buff (攻擊力 +50%)。',
            resultType: 'buff',
            buffId: 'demon_rage',
            icon: '🔥',
            materials: [
        ...
        potion_def: {
            id: 'potion_def',
            name: '🛡️ 鋼鐵防禦藥劑',
            desc: '在下次事件開始時，獲得【天使的加護】Buff (怪物傷害 -30%)。',
            resultType: 'buff',
        ...
        potion_revive: {
            id: 'potion_revive',
            name: '✨ 簡易復活藥水',
            desc: '戰鬥中死亡時，有 50% 機率復活，恢復 10% HP。 (無法帶出戰局)',
