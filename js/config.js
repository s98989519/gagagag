...
var CONFIG = {
    ...
    classes: {
        ...
        thief: {
            ...
            skill: {
                name: '暗影一擊',
                desc: '消耗 8 SP，造成 150% 傷害並獲得 +15% 閃避率 (3回合)。',
                type: '終結技'
            },
            ...
            skillUpgrade: {
                ...
                descriptions: {
                    ...
                    thief: {
                        ...
                        3: "造成 200% 傷害，+18% 閃避率 (3回合)，下擊必爆。",
                        4: "造成 230% 傷害，+18% 閃避率 (4回合)，下擊必爆。",
                        5: "造成 250% 傷害，+20% 閃避率 (4回合)，下擊必爆。SP消耗-1",
                        6: "造成 300% 傷害，+20% 閃避率 (4回合)，閃避後必爆。SP消耗-2"
                    },
                    cultist: {
