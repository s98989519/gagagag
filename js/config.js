...
var CONFIG = {
    ...
    runes: {
        ...
        evasion_boost: { id: 'evasion_boost', name: '💨 靈巧閃避', desc: '永久提升基礎閃避率 10%', cost: 120, materials: [{ item: '靈質', count: 8 }], effect: { type: 'evasion_base', val: 10 } },
    ...
    craftingRecipes: {
        ...
        // --- 狂狼系列 ---
        acc_wolf_1: { id: 'acc_wolf_1', name: "狼皮手套", type: 'accessory', rarity: 'common', price: 200, icon: "⚪", desc: "致命一擊機率 +3%", materials: [{ item: "狼皮", count: 25 }] },
        acc_wolf_2: { id: 'acc_wolf_2', name: "狼牙項鍊", type: 'accessory', rarity: 'rare', price: 800, icon: "🔵", desc: "致命一擊機率 +5%", materials: [{ item: "狼牙", count: 15 }] },
        acc_wolf_3: { id: 'acc_wolf_3', name: "血月披風", type: 'accessory', rarity: 'epic', price: 3000, icon: "🟠", desc: "致命一擊機率 +10%", materials: [{ item: "狼王披風", count: 8 }] },
        ...
        // --- 半獸人系列 ---
        acc_orc_1: { id: 'acc_orc_1', name: "斷劍墜飾", type: 'accessory', rarity: 'common', price: 300, icon: "⚪", desc: "遇到哈比時 50% 機率自動擊退 (500 G)", materials: [{ item: "斷劍", count: 25 }] },
        acc_orc_2: { id: 'acc_orc_2', name: "獸角護符", type: 'accessory', rarity: 'rare', price: 1200, icon: "🔵", desc: "遇到哈比時自動擊退 (600 G)", materials: [{ item: "半獸人護符", count: 15 }] },
        acc_orc_3: { id: 'acc_orc_3', name: "威望號角", type: 'accessory', rarity: 'epic', price: 4000, icon: "🟠", desc: "哈比事件必定擊退並獲得額外獎勵 (800 G)", materials: [{ item: "戰爭號角", count: 8 }] },

        // --- 幽靈系列 ---
        acc_ghost_1: { id: 'acc_ghost_1', name: "鬼火靈珠", type: 'accessory', rarity: 'common', price: 350, icon: "⚪", desc: "閃避率 +5%", materials: [{ item: "靈質", count: 25 }] },
        acc_ghost_2: { id: 'acc_ghost_2', name: "怨念寶石", type: 'accessory', rarity: 'rare', price: 1500, icon: "🔵", desc: "閃避率 +10%", materials: [{ item: "怨念集合體", count: 15 }] },
        acc_ghost_3: { id: 'acc_ghost_3', name: "冥界提燈", type: 'accessory', rarity: 'epic', price: 4500, icon: "🟠", desc: "閃避率 +15%", materials: [{ item: "幽靈提燈", count: 8 }] },
    ...
    hub: {
        ...
        training: {
            ...
            skillUpgrade: {
                ...
                costs: {
                    knight: {
                        1: { ep: 200, materials: [{ item: '斷劍', count: 15 }, { item: '石塊', count: 15 }] },
                        2: { ep: 300, materials: [{ item: '骨頭', count: 15 }, { item: '半獸人護符', count: 5 }] },
                        3: { ep: 400, materials: [{ item: '魔力核心', count: 3 }, { item: '狼牙', count: 10 }] },
                        4: { ep: 500, materials: [{ item: '戰爭號角', count: 2 }, { item: '龍鱗', count: 5 }] },
                        5: { ep: 600, materials: [{ item: '大地之心', count: 1 }, { item: '龍心', count: 1 }] }
                    },
                    merchant: {
                        1: { ep: 200, materials: [{ item: '史萊姆精華', count: 5 }, { item: '破布', count: 20 }] },
                        2: { ep: 300, materials: [{ item: '哥布林耳環', count: 8 }, { item: '狼皮', count: 10 }] },
                        3: { ep: 400, materials: [{ item: '哥布林金牙', count: 3 }, { item: '幽靈提燈', count: 2 }] },
                        4: { ep: 500, materials: [{ item: '食人妖之血', count: 3 }, { item: '龍之淚', count: 2 }] },
                        5: { ep: 600, materials: [{ item: '魔王印記', count: 1 }, { item: '史萊姆王冠', count: 1 }] }
                    },
                    thief: {
                        1: { ep: 200, materials: [{ item: '狼皮', count: 15 }, { item: '史萊姆黏液', count: 15 }] },
                        2: { ep: 300, materials: [{ item: '狼牙', count: 10 }, { item: '靈質', count: 10 }] },
                        3: { ep: 400, materials: [{ item: '狼王披風', count: 1 }, { item: '怨念集合體', count: 5 }] },
                        4: { ep: 500, materials: [{ item: '哥布林金牙', count: 3 }, { item: '死靈頭骨', count: 2 }] },
                        5: { ep: 600, materials: [{ item: '黑暗物質', count: 1 }, { item: '龍之淚', count: 1 }] }
                    },
                    cultist: {
                        1: { ep: 200, materials: [{ item: '史萊姆黏液', count: 20 }, { item: '靈質', count: 10 }] },
                        2: { ep: 300, materials: [{ item: '靈魂碎片', count: 10 }, { item: '半獸人護符', count: 5 }] },
                        3: { ep: 400, materials: [{ item: '怨念集合體', count: 5 }, { item: '死靈頭骨', count: 2 }] },
                        4: { ep: 500, materials: [{ item: '魔力核心', count: 3 }, { item: '黑暗物質', count: 2 }] },
                        5: { ep: 600, materials: [{ item: '魔神之眼', count: 1 }, { item: '魔王印記', count: 1 }] }
                    },
                    scarecrow: {
                        1: { ep: 200, materials: [{ item: '破布', count: 25 }, { item: '巨棒', count: 5 }] },
                        2: { ep: 300, materials: [{ item: '靈質', count: 15 }, { item: '狼王披風', count: 1 }] },
                        3: { ep: 400, materials: [{ item: '幽靈提燈', count: 2 }, { item: '怨念集合體', count: 5 }] },
                        4: { ep: 500, materials: [{ item: '死靈頭骨', count: 3 }, { item: '哥布林耳環', count: 10 }] },
                        5: { ep: 600, materials: [{ item: '食人妖圖騰', count: 1 }, { item: '黑暗物質', count: 1 }] }
                    },
                    ape: {
                        1: { ep: 200, materials: [{ item: '木棒', count: 10 }, { item: '石塊', count: 15 }] },
                        2: { ep: 300, materials: [{ item: '巨棒', count: 5 }, { item: '狼牙', count: 10 }] },
                        3: { ep: 400, materials: [{ item: '食人妖之血', count: 3 }, { item: '半獸人護符', count: 5 }] },
                        4: { ep: 500, materials: [{ item: '龍鱗', count: 5 }, { item: '魔力核心', count: 2 }] },
                        5: { ep: 600, materials: [{ item: '大地之心', count: 1 }, { item: '食人妖圖騰', count: 1 }] }
                    }
                },
                // 技能數值描述 (用於UI顯示)
                ...
                descriptions: {
                    ...
                    cultist: {
                        ...
                        3: "造成 200% 傷害，隨機獲得 1 個強化惡魔 Buff (4回合)。",
                    ...
                    scarecrow: {
                        1: "造成 200% 傷害，50% 機率暈眩。",
                        2: "造成 220% 傷害，60% 機率暈眩。",
                        3: "造成 250% 傷害，70% 機率暈眩，成功暈眩後恢復失去生命的 10%。",
                        4: "造成 280% 傷害，80% 機率暈眩，成功暈眩後恢復失去生命的 20%。",
                        5: "造成 300% 傷害，90% 機率暈眩，成功暈眩後恢復失去生命的 30%。SP消耗-1",
                        6: "造成 350% 傷害，100% 機率暈眩，成功暈眩後恢復失去生命的 50%。SP消耗-2"
                    },
                    ape: {
