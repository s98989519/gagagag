...
var CONFIG = {
    ...
    runes: {
        ...
        merchant_refresh: { id: 'merchant_refresh', name: '🔄 商販之友', desc: '允許在商店中刷新販賣物品（每次訪問商店可使用一次）', cost: 50, materials: [{ item: '破布', count: 10 }], effect: { type: 'merchant_refresh', val: 1 } },
        workbench_master: { id: 'workbench_master', name: '🔧 工匠大師', desc: '使用行動工作台時素材消耗降低 50%（原為 30%）', cost: 50, materials: [{ item: '魔力核心', count: 5 }], effect: { type: 'workbench_discount', val: 0.5 } }
    },
    ...
    craftingRecipes: {
        ...
        // --- 史萊姆系列 ---
        acc_slime_1: { id: 'acc_slime_1', name: "凝膠戒指", type: 'accessory', rarity: 'common', price: 100, icon: "⚪", desc: "毫無用處", materials: [{ item: "史萊姆黏液", count: 20 }] },
        acc_slime_2: { id: 'acc_slime_2', name: "精華護身符", type: 'accessory', rarity: 'rare', price: 500, icon: "🔵", desc: "每次事件回復 2 點生命", materials: [{ item: "史萊姆精華", count: 20 }] },
        ...
        // --- 哥布林系列 ---
        acc_gob_1: { id: 'acc_gob_1', name: "破布背包", type: 'accessory', rarity: 'common', price: 150, icon: "⚪", desc: "金幣獲取量 +5% (非商人)", materials: [{ item: "破布", count: 20 }] },
        acc_gob_2: { id: 'acc_gob_2', name: "金耳環", type: 'accessory', rarity: 'rare', price: 600, icon: "🔵", desc: "金幣獲取量 +10% (非商人)", materials: [{ item: "哥布林耳環", count: 20 }] },
        ...
        // --- 狂狼系列 ---
        acc_wolf_1: { id: 'acc_wolf_1', name: "狼皮手套", type: 'accessory', rarity: 'common', price: 200, icon: "⚪", desc: "致命一擊機率 +1%", materials: [{ item: "狼皮", count: 20 }] },
        acc_wolf_2: { id: 'acc_wolf_2', name: "狼牙項鍊", type: 'accessory', rarity: 'rare', price: 800, icon: "🔵", desc: "致命一擊機率 +3%", materials: [{ item: "狼牙", count: 20 }] },
        acc_wolf_3: { id: 'acc_wolf_3', name: "血月披風", type: 'accessory', rarity: 'epic', price: 3000, icon: "🟠", desc: "致命一擊機率 +8%", materials: [{ item: "狼王披風", count: 8 }] },

        // --- 骷髏系列 ---
        acc_skel_1: { id: 'acc_skel_1', name: "骨戒", type: 'accessory', rarity: 'common', price: 250, icon: "⚪", desc: "傷害減少 5% (不含暴擊)", materials: [{ item: "骨頭", count: 20 }] },
        acc_skel_2: { id: 'acc_skel_2', name: "靈魂容器", type: 'accessory', rarity: 'rare', price: 1000, icon: "🔵", desc: "傷害減少 10% (不含暴擊)", materials: [{ item: "靈魂碎片", count: 20 }] },
        ...
        // --- 半獸人系列 ---
        acc_orc_1: { id: 'acc_orc_1', name: "斷劍掛飾", type: 'accessory', rarity: 'common', price: 300, icon: "⚪", desc: "哈比事件擊退率 +10%", materials: [{ item: "斷劍", count: 20 }] },
        acc_orc_2: { id: 'acc_orc_2', name: "蠻族護符", type: 'accessory', rarity: 'rare', price: 1200, icon: "🔵", desc: "哈比事件擊退率 +30%", materials: [{ item: "半獸人護符", count: 20 }] },
        acc_orc_3: { id: 'acc_orc_3', name: "威望號角", type: 'accessory', rarity: 'epic', price: 4000, icon: "🟠", desc: "哈比事件必定擊退", materials: [{ item: "戰爭號角", count: 8 }] },

        // --- 幽靈系列 ---
        acc_ghost_1: { id: 'acc_ghost_1', name: "靈質斗篷", type: 'accessory', rarity: 'common', price: 350, icon: "⚪", desc: "逃跑成功率 +2%", materials: [{ item: "靈質", count: 20 }] },
        acc_ghost_2: { id: 'acc_ghost_2', name: "怨念念珠", type: 'accessory', rarity: 'rare', price: 1500, icon: "🔵", desc: "逃跑成功率 +5%", materials: [{ item: "怨念集合體", count: 20 }] },
        ...
        // --- 石巨人系列 ---
        acc_golem_1: { id: 'acc_golem_1', name: "石塊徽章", type: 'accessory', rarity: 'common', price: 500, icon: "⚪", desc: "生命上限 +30", materials: [{ item: "石塊", count: 20 }] },
        acc_golem_2: { id: 'acc_golem_2', name: "魔導核心", type: 'accessory', rarity: 'rare', price: 2000, icon: "🔵", desc: "生命上限 +100", materials: [{ item: "魔力核心", count: 20 }] },
        ...
        // --- 食人妖系列 ---
        acc_troll_1: { id: 'acc_troll_1', name: "木棒護身符", type: 'accessory', rarity: 'common', price: 600, icon: "⚪", desc: "攻擊力 +10", materials: [{ item: "巨棒", count: 20 }] },
        acc_troll_2: { id: 'acc_troll_2', name: "鮮血瓶", type: 'accessory', rarity: 'rare', price: 2500, icon: "🔵", desc: "攻擊力 +20", materials: [{ item: "食人妖之血", count: 20 }] },
        acc_troll_3: { id: 'acc_troll_3', name: "古老圖騰", type: 'accessory', rarity: 'epic', price: 7000, icon: "🟠", desc: "攻擊力 +35", materials: [{ item: "食人妖圖騰", count: 8 }] },

        // --- 雙足飛龍系列 ---
        acc_wyv_1: { id: 'acc_wyv_1', name: "龍鱗片", type: 'accessory', rarity: 'common', price: 1000, icon: "⚪", desc: "首領傷害 +5%", materials: [{ item: "龍鱗", count: 20 }] },
        acc_wyv_2: { id: 'acc_wyv_2', name: "龍淚墜飾", type: 'accessory', rarity: 'rare', price: 4000, icon: "🔵", desc: "首領傷害 +8%", materials: [{ item: "龍之淚", count: 20 }] },
        acc_wyv_3: { id: 'acc_wyv_3', name: "真龍之心", type: 'accessory', rarity: 'epic', price: 8000, icon: "🟠", desc: "首領傷害 +20%", materials: [{ item: "龍心", count: 8 }] },

        // --- 魔王系列 ---
        acc_demon_1: { id: 'acc_demon_1', name: "黑暗碎片", type: 'accessory', rarity: 'rare', price: 2000, icon: "⚪", desc: "攻+10 HP+10 暴+2%", materials: [{ item: "黑暗物質", count: 20 }] },
        acc_demon_2: { id: 'acc_demon_2', name: "魔君徽章", type: 'accessory', rarity: 'epic', price: 5000, icon: "🔵", desc: "攻+20 HP+20 暴+5%", materials: [{ item: "魔王印記", count: 20 }] },
