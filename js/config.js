...
var CONFIG = {
    ...
    rarityDisplay: {
        ...
        special: { color: "rarity-rare", label: "特殊", val: 4 } // 新增特殊稀有度
    },
    ...
    runes: {
        ...
        passive_gold: { id: 'passive_gold', name: '💰 貪婪之手', desc: '永久提升金幣獲取量 15%', cost: 200, materials: [{ item: '哥布林金牙', count: 5 }], effect: { type: 'gold_mult', val: 0.15 } },
        crit_boost: { id: 'crit_boost', name: '⚡ 致命專注', desc: '永久提升基礎暴擊率 3%', cost: 150, materials: [{ item: '狼牙', count: 10 }], effect: { type: 'crit_base', val: 3 } },
    ...
    museumSets: [
        ...
        },
        {
            ...
            name: '稀有礦物收藏',
            items: ['石塊', '魔力核心', '大地之心'],
            reward: { type: 'def_mult', val: 0.05, desc: '減傷 +5%' }
        },
        {
            id: 'boss_set',
            name: '首領收藏',
        ...
        },
        {
            ...
            reward: { type: 'all_stats', val: 0.05, desc: '全屬性 +5%' }
        }
    ],
