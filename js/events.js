...
const EventSystem = {
    ...
    triggerTemple() {
        ...
        const canDonate = window.Player.gold >= 2000;
        const btnText = canDonate ? "捐獻 (2000 G)" : "金幣不足 (2000 G)";
     ...
     */
    donateTemple() {
        if (window.Player.gold < 2000) {
            window.Game.showFloatingText("金幣不足！", "red");
            return;
        }

        window.Player.gold -= 2000;
        window.Game.showFloatingText("-2000 G", "yellow");
