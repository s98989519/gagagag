...
const Game = {
    ...
    enterHub() {
        ...
        // [Fix] 強制移除存檔，確保進入大廳時不會有冒險存檔
        localStorage.removeItem('fantasy_adventure_save');
        Player.class = null; // [Fix] 確保職業為空
        ...
        if (hubContent) {
            // Clear content to force re-render if needed, but mainly we want to ensure it's visible
            // hubContent.innerHTML = ''; // Do NOT clear here, let renderHubMenu handle it or just leave it
        }
